...
function MarketDetailContent({ params }: { params: { id: string } }) {
  ...
  const PlatformIcon =
    mockMarket.platform === 'twitter' ? Twitter : MessageSquare
    ...
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card className="p-6 bg-card border-border">
            <div className="flex items-start justify-between mb-4">
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <Badge className="gold-gradient text-background">
                    {mockMarket.status}
                  </Badge>
                </div>
            ...
            <div className="flex items-center gap-2 pt-4 border-t border-border">
              ...
              >
                <Bookmark
                  className={`w-4 h-4 ${
                    isBookmarked ? 'fill-gold-2 text-gold-2' : ''
                  }`}
                />
                {isBookmarked ? 'Saved' : 'Save'}
              </Button>
              <a
                href={mockMarket.postUrl}
                target="_blank"
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <Card className="p-4 bg-card border-border">
              ...
              <p className="text-2xl font-bold">
                ${mockMarket.totalPool.toLocaleString()}
              </p>
            </Card>
            ...
            <TabsContent value="info" className="mt-4">
              <Card className="p-6 bg-card border-border space-y-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    {mockMarket.createdAt.toLocaleDateString()}
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    {mockMarket.endsAt.toLocaleDateString()}
                  </p>
                </div>
                ...
                <Alert>
                  ...
                  <AlertDescription>
                    This is an experimental prediction market. Only bet what you
                    can afford to lose. Markets are resolved by the creator
                    based on the stated resolution source.
                  </AlertDescription>
                </Alert>
              </Card>
            </TabsContent>
          ...
          {/* Social Post Embed */}
          <SocialPostEmbed
            platform={mockMarket.platform}
            postUrl={mockMarket.postUrl}
          />
        </div>
...
export default function MarketDetailPage({
  ...
  return (
    <Suspense
      fallback={
        <div className="max-w-7xl mx-auto space-y-6 p-6">Loading...</div>
      }
    >
